'''Учебным проектом, который благородно предоставил вам Тимур.'''
...
def attack(char_name: str, char_class: str) -> str:
    '''Функция расчета урона в зависимости от выбранного класса.'''
    ...
    if char_class == 'healer':
        return (f'{char_name} нанёс урон противнику равный '
                f'{5 + randint(-3, -1)}')
    return (f'{char_name} нанёс 0 урона противнику')


def defence(char_name: str, char_class: str) -> str:
    '''Функция расчета заблокированного урона.'''
    if char_class == 'warrior':
